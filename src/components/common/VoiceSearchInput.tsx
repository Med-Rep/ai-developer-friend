...
import { Mic, MicOff, Search, Clock, Star, Command } from 'lucide-react';
...
export function VoiceSearchInput({ 
  ...
  const defaultSuggestions: Record<string, SuggestionItem[]> = {
    legal: [
      ...
      { id: '6', text: 'Code de procédure civile', type: 'legal_term', category: 'Code' },
      { id: '7', text: 'Code pénal algérien', type: 'legal_term', category: 'Code' }
    ],
    procedure: [
      ...
      { id: '5', text: 'Carte d\'identité nationale', type: 'template', category: 'Identité' },
      { id: '6', text: 'Certificat de résidence', type: 'template', category: 'Administration' }
    ],
    search: [
      ...
      { id: '4', text: 'modifications législatives', type: 'suggestion' }
    ],
    general: [
